...
where $\textbf{K}_p$ is the desired stiffness, and $\textbf{K}_d$ is the
desired damping. This control law is commonly used as an inner-loop controller
in an MPC framework. [^1] [^2]
